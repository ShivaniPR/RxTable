...
class ViewController: UIViewController,UICollectionViewDelegateFlowLayout{
    ...
    let collectionView: UICollectionView = {
        ...
        cv.register(NumberDisplay.self , forCellWithReuseIdentifier: "Cell")
        return cv
    }()
    ...
    func tapCell(){
        collectionView.rx.itemSelected
            .subscribe(onNext:{ indexPath in
                ...
                if let cell = self.collectionView.cellForItem(at: indexPath) as? NumberDisplay {
                    cell.onTapImage(playerNumber: self.playerNumber)
                }
